...
public class UITextHandler : MonoBehaviour
{
    ...
    public void SetText()
    {
        if (Localization._Instance._UI.Count >= Number && Localization._Instance._UI[Number - 1] != null)

            GetComponent<TextMeshProUGUI>().text = Localization._Instance._UI[Number - 1];
    }
